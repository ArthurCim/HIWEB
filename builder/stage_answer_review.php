...
<style>
    ...
    .stats-card.correct::before { background: var(--success-gradient); }
    .stats-card.incorrect::before { background: var(--danger-gradient); }
    .stats-card.accuracy::before { background: var(--info-gradient); }
